...
/**
 * Enhanced progress callback with server name and percentage
 */
export type EnhancedProgressCallback = (server: string, percentage: number, status: string) => void
...
export interface LSPManagerOptions {
  ...
  bunPath?: string
  /** Project path for multi-session isolation (optional) */
  projectPath?: string
}
...
export interface LSPManagerEvents {
  ...
  'server-installing': { serverId: string; progress: InstallProgress }

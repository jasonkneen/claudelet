 ...
 */
export type WorkerTask = WorkerInitializeTask | WorkerEmbedTask | WorkerEmbedBatchTask | WorkerDisposeTask;
/**
 * Worker result base
 */
 ...
 */
export type WorkerResult = WorkerInitializeResult | WorkerEmbedResult | WorkerEmbedBatchResult | WorkerDisposeResult;
/**
...
export declare const IPC_CHANNELS: {
    readonly SEARCH: "mgrep:search";
    readonly INDEX_FILE: "mgrep:index-file";
    readonly INDEX_WORKSPACE: "mgrep:index-workspace";
    readonly DELETE_FILE: "mgrep:delete-file";
    readonly GET_STATUS: "mgrep:get-status";
    readonly GET_STATS: "mgrep:get-stats";
    readonly FILE_CHANGE: "mgrep:file-change";
    readonly PROGRESS: "mgrep:progress";
};
/**
...
export interface MgrepIPCHandlers {
    ...
    [IPC_CHANNELS.INDEX_WORKSPACE]: () => Promise<{
        totalChunks: number;

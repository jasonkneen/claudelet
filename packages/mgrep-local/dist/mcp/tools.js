...
export const SEMANTIC_SEARCH_TOOL = {
    ...
    description: 'Search the codebase semantically by meaning and intent. ' +
 ...
 */
export const INDEX_STATUS_TOOL = {
    name: MCP_TOOLS.INDEX_STATUS,
    description: 'Get the current status of the semantic index. ' +
 ...
 */
export const INDEX_DIRECTORY_TOOL = {
    ...
    inputSchema: {
        ...
        properties: {
            directory: {
                type: 'string',
                description: 'Path to the directory to index. Use "." for current directory. ' +
...
export const CLEAR_INDEX_TOOL = {
    ...
    description: 'Clear the entire semantic index. ' +

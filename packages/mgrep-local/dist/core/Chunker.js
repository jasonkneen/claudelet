...
export class Chunker {
     ...
     */
    chunkByStructure(code, language) {
     ...
     */
    chunkBySlidingWindow(code, language) {
        const chunks = [];
        const lines = code.split('\n');
        let currentChunk = '';
     ...
     */
    splitLargeChunk(content, language, baseStartLine, functionName) {
        const chunks = [];
     ...
     */
    getOverlapLines(content, maxLength) {

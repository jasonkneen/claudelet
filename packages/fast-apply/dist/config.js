...
exports.USER_PROMPT_TEMPLATE = exports.SYSTEM_PROMPT = exports.MAX_TOKENS = exports.TEMPERATURE = exports.INFERENCE_TIMEOUT = exports.DEFAULT_STORAGE_DIR = exports.MODEL_REPO = exports.DEFAULT_MODEL = exports.MODELS = void 0;
 ...
 */
exports.USER_PROMPT_TEMPLATE = `Apply the update to the code. If the update shows "FIND: X" and "REPLACE WITH: Y", find X in the code and replace it with Y. Do NOT insert duplicates - replace in-place.
 ...
 */
function buildPrompt(originalCode, updateSnippet) {
    const userPrompt = exports.USER_PROMPT_TEMPLATE
        .replace('{original_code}', originalCode)
        .replace('{update_snippet}', updateSnippet);
    // Use ChatML format for Qwen models
    return `<|im_start|>system
${exports.SYSTEM_PROMPT}<|im_end|>
<|im_start|>user
${userPrompt}<|im_end|>
<|im_start|>assistant
`;
